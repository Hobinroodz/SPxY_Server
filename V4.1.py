...
class Feedback:
    ...
    def __init__(self, master):
        ...
        ttk.Label(self.graphic_display_frame, text="Camera display").grid(row=0,padx=100,)
        ttk.Label(self.graphic_display_frame, text="Model trajectory").grid(row=1,padx=100,pady=(120,0))
